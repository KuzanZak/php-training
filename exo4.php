    ...
    <div class="container">
        ...
        <section class="exercice">
            ...
            <div class="exercice-sandbox">
                <ul>
                    <?php
                    function displayE(array $array)
                    {
                        foreach ($array as $key) {
                            if (is_int($key) == true && $key % 2 !== 1) echo "<li>$key</li>";
                        }
                    }
        ...
        <section class="exercice">
            ...
            <div class="exercice-sandbox">
                <ul>
                    <?php
                    function displayI(array $array)
                    {
                        foreach ($array as $key) {
                            if (array_search($key, $array) % 2 !== 1) echo "<li>$key</li>";
                        }
                    }
                    echo displayI($arrayA);
                    ?>
                </ul>
